<table style="background-color: #00000" width="1000" border="0" cellspacing="0" cellpadding="0" style="background-color: #000000">
    <tbody>
        <tr style="background-color: #a2200a;">
        ...
        <tr>
            <td colspan="3" align="center">
                <a href="<?php echo $link; ?>">
                    <img data-imagetype="External" src="https://formatic.com.co/assets/emails/activeEmail/obsequio-access.png" width="100%" alt="Access al dia" title="" border="0" style="display:block">
                </a>
            </td>
            <tr>
                <tr style="background-color: #a2200a ; align-items: center">
                    <td style="width: 100%;">
                        <a href="<?php echo $link; ?>">
