<table style="background-color: #00000" width="1000" border="0" cellspacing="0" cellpadding="0" style="background-color: #000000">
    <tbody>
        <tr style="background-color: #1824a4;">
        ...
        <tr>
            <td colspan="3" align="center">
                <a href="<?php echo $link; ?>">
                    <img data-imagetype="External" src="https://formatic.com.co/assets/emails/activeEmail/obsequio-word.png" width="100%" alt="Word al dia" title="" border="0" style="display:block">
                </a>
            </td>
            <tr>
