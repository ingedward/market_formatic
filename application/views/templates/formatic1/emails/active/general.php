<table style="background-color: #00000" width="1000" border="0" cellspacing="0" cellpadding="0" style="background-color: #000000">
    <tbody>
        <tr style="background-color: #101768;">
            <td style=" text-align: center; color: #fff;">
                <p style="padding-top: 16px; margin-bottom: 16px; font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-size: 20px">
                    Hola 
                    <strong style="font-style: capitalize;">
        ...
        <tr>
            <td colspan="3" align="center">
                <a href="<?php echo $link; ?>">
                    <img data-imagetype="External" src="https://formatic.com.co/assets/emails/activeEmail/Mail-de-Bienvenida.png" width="100%" alt="Excel al dia" title="" border="0" style="display:block">
                </a>
            </td>
            <tr>
                <tr style="background-color: #101768 ; align-items: center">
                    <td style="width: 100%;">
                        <a href="<?php echo $link; ?>">
...
border-radius: 10px 10px 10px 10px; font-family:Helvetica,Arial,sans; font-size:50px; font-weight:bold;
 text-align:center; text-decoration:none; color:inherit; color:#101768; font-size:20px; font-weight:bold;
