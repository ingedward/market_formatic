...
#--- Adicionado Edward Payu
$route['(\w{2})?/?checkout/payupayment']    = 'checkout/payuPayment';
#--- Adicionado Edward Payu pruebas 20200902
$route['(\w{2})?/?checkout/payupaymenttest']= 'checkout/payuPaymentTest';
...
$route['admin/orders/download']   = "admin/ecommerce/orders/download";
...
/*
  | -------------------------------------------------------------------------
  | Rutas adicionadas Edward para Formatic
  | -------------------------------------------------------------------------
 */

/* Payu */
$route['payment/payu/response']     = 'Checkout/payuResponse';
$route['payment/payu/confirmation'] = 'Checkout/payuConfirmation';
