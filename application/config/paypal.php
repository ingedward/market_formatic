...
$config['business'] = 'sb-pdvem2613104@business.example.com';
//$config['business'] = 'sandrapinto@formatic.com.co';


// What is the default currency?
$config['paypal_lib_currency_code'] = 'USD'; //--- Edward
//$config['paypal_lib_currency_code'] = 'COP';
