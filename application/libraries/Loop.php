...
?>
                    ...
                    <?php
                        ...
                        while ($i < count($products)) 
                        {
                            if ($i == 0)
                                ...
                                $active = '';
                            ?>
                            <li data-target="#small_carousel" data-slide-to="<?= $i ?>" class="<?= $active ?>">
                            </li>
                            <?php
                            $i++;
                        }
    ...
    static public function getProductsFull($products, $classes = '', $carousel = false)
    {
        if ($carousel == true) 
        {
            ?>
            <div class="carousel slide" id="small_carousel" data-ride="carousel" data-interval="3000">
                ...
                <?php
                    ...
                    foreach ($products as $article) 
                    {
                        ...
                        #--- Adicionado edward para marcar los que no son de promocion
                        if ($article['procurement']== 0 && $article['name']== 'Cursos')
                        {
...
<!-- MODIFICADO EDWARD
                    <div class="product-list <?= $carousel == true ? 'item' : '' ?> <?= $classes ?> <?= $active ?>">
 -->
                   <div class="product-list <?= $carousel == true ? 'item' : '' ?> <?= $classes ?> <?= $active ?>"  style="background-color: #FFFFFF;"  >
                         <div class="inner">
                            <div class="img-container">
                    ...
                    <?php
                    $i++;
                    }   #--- cierre del if adicionado por Edward
    ...
    #--- Adicionado Edward para productos en promocion
    static public function getProductsOfert($products, $classes = '', $carousel = false)
    {
        if ($carousel == true) 
        {
            ?>
            <div class="carousel slide" id="small_carousel" data-ride="carousel" data-interval="3000">
                ...
                <?php
                    ...
                    foreach ($products as $article) 
                    {
                        ...
                        #--- Adicionado edward para marcar los que no son de promocion
                        if ($article['procurement']== 1 && $article['name']== 'Cursos')
                        {
    ...
    #--- Muestra los productos del mes adicionado Edward 20200826-01
    static public function getProductsMonth($products, $classes = '', $carousel = false)
    {
        if ($carousel == true) 
        {
            ?>
            <div class="carousel slide" id="small_carousel" data-ride="carousel" data-interval="3000">
                ...
                <?php
                    ...
                    foreach ($products as $article) 
                    {
                        ...
                        #--- Adicionado edward para marcar los que no son de promocion
                        if ($article['procurement']== 0 && $article['name']== 'Productos')
                        {
