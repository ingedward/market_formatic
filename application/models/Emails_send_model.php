...
include(APPPATH.'libraries/Sendgrid/sendgrid-php.php');

/*
   Class: Emails_model
  
*/
class Emails_send_model extends CI_Model {
	var $sendgrid = null;
	var $sgemail  = null;
	function __construct()
    {
    	...
    	$options = array(
 		...
 		$this->sendgrid = new SendGrid('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', $options);
...
//			$this->email->from('mail@formatic.academy','Formatic');
			...
			$this->email->subject('Activa tus cursos Sendin'.$nombre.' '.$apellido);
