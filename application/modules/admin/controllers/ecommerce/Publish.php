...
class Publish extends ADMIN_Controller
{
    ...
    public function index($id = 0)
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            $this->session->set_flashdata('result_publish', 'Producto publicado!');
            if ($id == 0) {
                $this->saveHistory('Producto publicado con éxito');
            } else {
                $this->saveHistory('Producto actualizado con éxito');
            }
