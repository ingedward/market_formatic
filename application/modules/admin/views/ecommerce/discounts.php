...
<h1>
    <img src="<?= base_url('assets/imgs/discount.png') ?>" class="header-img" style="margin-top:-3px;"> 
    Cupones descuento
</h1>
<hr>
<div style="margin-bottom: 20px;">
    <a href="javascript:void(0);" data-toggle="modal" data-target="#addDiscountCode" class="btn btn-primary pull-left">
        <b>+</b> Adicionar cupón descuento
    </a>
    <form method="POST" action="" class="pull-right">
        <label>Cupón descuento</label>
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            if (!empty($discountCodes)) {
                    ...
                    <tr> 
                        ...
                        <td class="text-center">
                            <a href="<?= base_url('admin/discounts?codeid=' . $code['id'] . '&tostatus=' . $tostatus) ?>">
                                <?= $code['status'] == 1 ? '<span class="label label-success">Activo</span>' : '<span class="label label-danger">Inactivo</span>' ?>
                            </a>
                        </td>
                        <td class="text-center">
                            <a href="<?= base_url('admin/discounts?edit=' . $code['id']) ?>" class="btn btn-primary btn-xs">Editar</a>
                        </td>
                    </tr> 
                    <?php
                }
                ...
                ?>
                <tr>
                    <td colspan="6">No se agregaron cupones de descuento</td> 
                </tr> 
            <?php } ?>
        </tbody>
    </table>
        ...
        <div class="modal-content">
            <form action="" method="POST">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Agregar cupón de descuento</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group" style="position: relative;">
                        ...
                        <div style="position: absolute; right:5px; top:30px;">
                            ...
                            <a href="javascript:void(0);" onclick="generateDiscountCode()" class="btn btn-xs btn-default">Generar</a>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Válido desde la fecha</label>
                    ...
                    <div class="form-group">
                        <label>Válido hasta la fecha</label>
