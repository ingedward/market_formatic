<div id="products">
    ...
    ?>
    <h1>
        <img src="<?= base_url('assets/imgs/products-img.png') ?>" class="header-img" style="margin-top:-2px;"> Productos
    </h1>
    <hr>
    <div class="row">
        <div class="col-xs-12">
                    ...
                    <form method="GET" id="searchProductsForm" action="">
                        <div class="col-sm-4">
                            ...
                            <select name="order_by" class="form-control selectpicker change-products-form">
                                <option <?= isset($_GET['order_by']) && $_GET['order_by'] == 'id=desc' ? 'selected=""' : '' ?> value="id=desc">Más nuevo</option>
                                <option <?= isset($_GET['order_by']) && $_GET['order_by'] == 'id=asc' ? 'selected=""' : '' ?> value="id=asc">Último</option>
                                <option <?= isset($_GET['order_by']) && $_GET['order_by'] == 'quantity=asc' ? 'selected=""' : '' ?> value="quantity=asc">Baja cantidad</option>
                                <option <?= isset($_GET['order_by']) && $_GET['order_by'] == 'quantity=desc' ? 'selected=""' : '' ?> value="quantity=desc">Mayor cantidad</option>
                            </select>
                        </div>
                        <div class="col-sm-4">
                            <label>Título:</label>
                            <div class="input-group">
                                <input class="form-control" placeholder="Titulo Producto" type="text" value="<?= isset($_GET['search_title']) ? $_GET['search_title'] : '' ?>" name="search_title">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="pull-right">
                                            ...
                                            <a href="<?= base_url('admin/products?delete=' . $row->id) ?>"  class="btn btn-danger confirm-delete">Eliminar</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php
