<div id="languages">
    <h1>
        <img src="<?= base_url('assets/imgs/categories.jpg') ?>" class="header-img" style="margin-top:-2px;">  Categorías de la Tienda
    </h1> 
    <hr>
    ...
    ?>
    <a href="javascript:void(0);" data-toggle="modal" data-target="#add_edit_articles" class="btn btn-primary btn-xs pull-right" style="margin-bottom:10px;">
        <b>+</b> 
        Adicionar categoria
    </a>
            ...
            <div class="modal-content">
                <form action="" method="POST">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Adicionar Categoría</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <?php } foreach ($languages as $language) { ?>
                            <div class="form-group">
                                <label>Nombre (<?= $language->name ?><img src="<?= base_url('attachments/lang_flags/' . $language->flag) ?>" alt="">)</label>
                                <input type="text" name="categorie_name[]" class="form-control">
                            </div>
                        <?php } ?>
                        <div class="form-group">
                            <label>Padre <sup>Esta categoría será subcategoría del padre</sup>:</label>
