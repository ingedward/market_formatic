    ...
    <div class="col-sm-8 col-md-7">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            foreach ($languages as $language) {
                ?>
                <div class="form-group">
                    <label for="description<?= $i ?>">Descripción (<?= $language->name ?>
                        <img src="<?= base_url('attachments/lang_flags/' . $language->flag) ?>" alt="">)</label>
            ...
            <div class="form-group">
                <?php if (isset($_POST['image'])) { ?>
                    ...
                    <label for="userfile">Elige otra imagen:</label>
                <?php } else { ?>
                    <label for="userfile">Cargar Imagén:</label>
                <?php } ?>
